...
def ground_truth_sports(data_file, result_dir):
    ...
    wktAll = wkthelper.readWKTToList(data_file)
    ...
    filename=result_dir+"/similarityMap"
...
def ground_truth_water_bodies(data_file, result_dir):
    # read and center the polygons
    print("Data reading")
...
def ground_truth_parks(data_file, result_dir):
    # read and center the polygons
    print("Data reading")
    # wktAll = wkthelper.readParks("../polygonalData/parks.tsv")
    # wktAll = wkthelper.readParks("../polygonalData/parks.tsv", poly_count=50000)
