...
# Run with no hang up: nohup time python groundtruthWritingParksFiltered.py > out-pkFiltered3.log&
...
def parks():
    ...
    # wktAll = wkthelper.readParks("../polygonalData/parks.tsv", poly_count=200)
    ...
    print("Polygon centering started")
    global wktList
    wktList=centerAllPolygons(wktListFiltered)
    print("Polygon centering complete!")
    
    # filename="../warehouse/pk-query-18701/similarityMap"    
    # filename="../warehouse/pk-fil_5e-07-5e-05/similarityMap"
    # filename="../warehouse/pk-fil_5e-06-5e-05/similarityMap"
    filename="../warehouse/pk-fil_5e-07-5e-06/similarityMap"
    fileSize=400   # define max entries in a single file
    pCount=60
    tCount=2
    match=0.6
